<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.15.6' || 'working' == 'v3.1.15') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magicslideshow&license=trial&tool_version=v3.1.15&module_version=v4.15.6&platform_name=magento&platform_version={$platformVersion}&url={$url}";
